          ...
          <div className="hidden md:flex items-center gap-1">
            {navLinks.map(({ to, label, icon: Icon }) => (
              <Link key={to} to={to}
                ...
                style={{
                  background: isActive(to) ? '#F0FDF9' : 'transparent',
                  color: isActive(to) ? '#0D9488' : '#6b7280',
                }}>
                <Icon size={15} />
                {label}
              </Link>
          ...
          <div className="flex flex-col gap-2 p-6">
            {navLinks.map(({ to, label, icon: Icon }) => (
              <Link key={to} to={to}
                ...
                style={{
                  background: isActive(to) ? '#0D9488' : 'white',
            ...
            <div className="h-px my-2" style={{ background: '#CCFBF1' }} />
            {user ? (
              <>
                <Link to="/dashboard"
                  onClick={() => setMenuOpen(false)}
